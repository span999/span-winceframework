...
bool RequestArrayAddDone( void )
{
	...
	DBGMSG("SPD@RequestArrayAddDone HeadCount=%d pArrayHead=0x%08x pArrayTail=0x%08x \n", (unsigned)HeadCount, (unsigned)pArrayHead, (unsigned)pArrayTail );
...
bool RequestArrayRemoveDone( void )
{
	...
	TailCount++;
	sArraySize = HeadCount - TailCount;
	DBGMSG("SPD@RequestArrayRemoveDone TailCount=%d pArrayHead=0x%08x pArrayTail=0x%08x \n", (unsigned)TailCount, (unsigned)pArrayHead, (unsigned)pArrayTail );
