...
typedef struct
{
    ...
    //
    //! A pointer to the image to be drawn onto above the background image for
    //! the button.
    //
...
//!
//! This function changes the color used to fill the image button on the
...
//!
//! This function changes the image that is drawn onto the image button.  The
...
//! is pressed.
//!
//! This function changes the image that is drawn onto the image button when it
