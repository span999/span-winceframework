...
typedef struct {
	...
	WORD      status;    			// Item status (selection, drawing ...)
	void*     pText;     			// Pointer to the text for the item
...
*							   SHORT bottom, WORD state, char* pText, 
*							   GOL_SCHEME *pScheme)
*
...
*								char *pText, WORD status, WORD data)
*
