...
gb_state_draw_lines:
        ...
        case GB_STATE_DRAWTOPRIGHT:
            ...
            if(IsDeviceBusy())
                return 0;    
			Line(textRight, top + 1, pGb->right, top + 1);	// top line at right
        ...
        case GB_STATE_DRAWTOPLEFT:
            ...
            if(IsDeviceBusy())
                return 0;    
			Line(pGb->left+1, top + 1, textLeft, top + 1);	// top line at left
        ...
        case GB_STATE_DRAWSIDELEFT:
            ...
            if(IsDeviceBusy())
                return 0;    
			Line(pGb->left+1, top + 1, 					\
			     pGb->left+1, pGb->bottom); 				// side line at left
