 ...
 * Darren Wenn			07/03/09	Modified for RTOS demo
 ********************************************************************/
#define __MPFS2_C
...
///////////////////////////////////////////////////////////////////
// on the Graphics PICTail+ V2 the FLASH is connected to the PMP
// as well as the QVGA so we need to regulate access to the bus
// it is convenient to use the QVGA semaphore for this purpose
