 ...
 * Darren Wenn			10/02/08    Modified for RTOS support
 *									srand no longer calls generate
 *									random dword as this causes conflict
********************************************************************/
#define __STACKTSK_C
...
void StackInit(void)
{
	...
	// we use a fixed value here to prevent the random routine
	// changing the configuration of the ADC
	srand(42);
