...
//Kathy01_01 end
#define IOCTL_HAL_GET_BT_UUID       				CTL_CODE(FILE_DEVICE_HAL,2073, METHOD_BUFFERED,FILE_ANY_ACCESS)    //Ryn0524
...
///span0607
///span1005, add IOCTL code for RTC ALARM SETTING, we will use it auto suspend/resume testing.
#define IOCTL_OEM_HAL_SET_RTCALARM					CTL_CODE(FILE_DEVICE_HAL,4015,METHOD_BUFFERED,FILE_ANY_ACCESS)
///span1005
// Ryn0310 Start
...
///span0823
///span1018, define for CUnit fromwork test
#define IOCTL_OEM_CUNIT_TEST						CTL_CODE(FILE_DEVICE_HAL,4076,METHOD_BUFFERED,FILE_ANY_ACCESS)
///span1018, define for CUnit fromwork test
...
#define IOCTL_HAL_GET_BTVERSION CTL_CODE( FILE_DEVICE_HAL, 2077, METHOD_BUFFERED, FILE_ANY_ACCESS )
#define IOCTL_HAL_GET_BTAPPVERSION CTL_CODE( FILE_DEVICE_HAL, 2078, METHOD_BUFFERED, FILE_ANY_ACCESS )
//jack0512 end
...
///span0804, add for earphon re-volume settting
///span0712, add for OEM OAL registry setting path
#define REG_PATH_OEM_OAL_SETTING				TEXT("Software\\OEM\\OAL")
///span0712, add for OEM OAL registry setting path
