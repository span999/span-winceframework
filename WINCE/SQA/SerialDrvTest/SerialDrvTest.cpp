// SerialDrvTest.cpp : Defines the entry point for the application.
//
...
SComBasicTest *pMyBasicTest = NULL;
					...
					int       nCmdShow)
{
	...
	hAccelTable = LoadAccelerators(hInstance, (LPCTSTR)IDC_SERIALDRVTEST);
...
ATOM MyRegisterClass(HINSTANCE hInstance, LPTSTR szWindowClass)
{
    ...
    wc.hIcon			= LoadIcon(hInstance, MAKEINTRESOURCE(IDI_SERIALDRVTEST));
    wc.hCursor			= 0;
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
	...
	LoadString(hInstance, IDC_SERIALDRVTEST, szWindowClass, MAX_LOADSTRING);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
///init test object
	pMyBasicTest = new SComBasicTest( 1, 100 );
	///init test item
	...
	pMyBasicTest->AddTestItem( IDM_BASIC_GPS );
...
/// Basic test ////////////////////////////////////////////////////////////////////////////////
				case IDM_BASIC_START:
					...
					{	
				   	...
				   	break;
				case IDM_BASIC_GPS:
					///spShowMsgString( _T("IDM_BASIC_GPS\0") );					
					if( !spIsMenuItemChecked( IDM_BASIC_START ) )
					{	
						spInvertMenuItemCheck( IDM_BASIC_GPS );
											
						spTestItemActiveSycnMenuCheck( IDM_BASIC_GPS );
					}	
...
static BOOL spIsAnyBasicItemChecked()
{
	...
	if( spIsMenuItemChecked( IDM_BASIC_GPS ) )
		bRet = TRUE;
///	else	
...
static BOOL spCheckBasicMenu()
{
	...
	if( spIsMenuItemChecked( IDM_BASIC_START ) )
	{
		EnableMenuItem( hMenuBar, IDM_BASIC_GPS, MF_BYCOMMAND|MF_GRAYED );
...
///		EnableMenuItem( hMenuBar, IDM_BASIC_ONOFF, MF_BYCOMMAND|MF_GRAYED );		
	...
	{
		EnableMenuItem( hMenuBar, IDM_BASIC_GPS, MF_BYCOMMAND|MF_ENABLED );
...
static void SetTestSettingDefault()
{
	...
	{	
		...
		pMyBasicTest->DeActiveTestItem( IDM_BASIC_GPS );
...
static void SetTestSettingStress()
{
	...
	{	
		...
		pMyBasicTest->ActiveTestItem( IDM_BASIC_GPS );
