// AudioDrvTest.cpp : Defines the entry point for the application.
//
...
SAudioBasicTest *pMyBasicTest = NULL;
					...
					int       nCmdShow)
{
	...
	hAccelTable = LoadAccelerators(hInstance, (LPCTSTR)IDC_AUDIODRVTEST);
...
ATOM MyRegisterClass(HINSTANCE hInstance, LPTSTR szWindowClass)
{
    ...
    wc.hIcon			= LoadIcon(hInstance, MAKEINTRESOURCE(IDI_AUDIODRVTEST));
    wc.hCursor			= 0;
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
	...
	LoadString(hInstance, IDC_AUDIODRVTEST, szWindowClass, MAX_LOADSTRING);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
///init test object
	pMyBasicTest = new SAudioBasicTest( 3, 100 );
	///init test item
	...
	pMyBasicTest->AddTestItem( IDM_BASIC_PLAYBACK );
	pMyBasicTest->AddTestItem( IDM_BASIC_VOLUME );
...
/// Basic test ////////////////////////////////////////////////////////////////////////////////
				...
				case IDM_BASIC_API:
					...
					{	
				   	...
				   	break;
				case IDM_BASIC_PLAYBACK:
					if( !spIsMenuItemChecked( IDM_BASIC_START ) )
					{	
						spInvertMenuItemCheck( IDM_BASIC_PLAYBACK );
					
						spTestItemActiveSycnMenuCheck( IDM_BASIC_PLAYBACK );
					}	
					
				   	break;
				case IDM_BASIC_VOLUME:
					if( !spIsMenuItemChecked( IDM_BASIC_START ) )
					{	
						spInvertMenuItemCheck( IDM_BASIC_VOLUME );
						
						spTestItemActiveSycnMenuCheck( IDM_BASIC_VOLUME );
					}					
				   	break;				   				   				   
/// Basic test ////////////////////////////////////////////////////////////////////////////////				   
/// Stress test ////////////////////////////////////////////////////////////////////////////////
...
static BOOL spIsAnyBasicItemChecked()
{
	...
	if( spIsMenuItemChecked( IDM_BASIC_PLAYBACK ) )
		bRet = TRUE;
	else	
	if( spIsMenuItemChecked( IDM_BASIC_VOLUME ) )
		bRet = TRUE;
	else
		bRet = FALSE;
...
static BOOL spCheckBasicMenu()
{
	...
	if( spIsMenuItemChecked( IDM_BASIC_START ) )
	{
		...
		EnableMenuItem( hMenuBar, IDM_BASIC_PLAYBACK, MF_BYCOMMAND|MF_GRAYED );
		EnableMenuItem( hMenuBar, IDM_BASIC_VOLUME, MF_BYCOMMAND|MF_GRAYED );		
	}
	else
	{
		EnableMenuItem( hMenuBar, IDM_BASIC_API, MF_BYCOMMAND|MF_ENABLED );
		EnableMenuItem( hMenuBar, IDM_BASIC_PLAYBACK, MF_BYCOMMAND|MF_ENABLED );
		EnableMenuItem( hMenuBar, IDM_BASIC_VOLUME, MF_BYCOMMAND|MF_ENABLED );		
	}		
...
static void SetTestSettingDefault()
{
	...
	{	
		...
		pMyBasicTest->DeActiveTestItem( IDM_BASIC_PLAYBACK );
		pMyBasicTest->DeActiveTestItem( IDM_BASIC_VOLUME );
	}	
}
...
static void SetTestSettingStress()
{
	...
	{	
		...
		pMyBasicTest->ActiveTestItem( IDM_BASIC_PLAYBACK );
		pMyBasicTest->ActiveTestItem( IDM_BASIC_VOLUME );
	}	
}