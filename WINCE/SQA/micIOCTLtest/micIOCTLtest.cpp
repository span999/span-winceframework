// micIOCTLtest.cpp : Defines the entry point for the application.
//
...
SIoctlBasicTest *pMyBasicTest = NULL;
					...
					int       nCmdShow)
{
	...
	hAccelTable = LoadAccelerators(hInstance, (LPCTSTR)IDC_MICIOCTLTEST);
...
ATOM MyRegisterClass(HINSTANCE hInstance, LPTSTR szWindowClass)
{
    ...
    wc.hIcon			= LoadIcon(hInstance, MAKEINTRESOURCE(IDI_MICIOCTLTEST));
    wc.hCursor			= 0;
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
	...
	LoadString(hInstance, IDC_MICIOCTLTEST, szWindowClass, MAX_LOADSTRING);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
///init test object
	pMyBasicTest = new SIoctlBasicTest( 1, 100 );
	///init test item
	...
	pMyBasicTest->AddTestItem( IDM_BASIC_PRX );
...
/// Basic test ////////////////////////////////////////////////////////////////////////////////
				case IDM_BASIC_START:
					...
					{	
				   	...
				   	break;
				case IDM_BASIC_PRX:
					///spShowMsgString( _T("IDM_BASIC_PRX\0") );					
					if( !spIsMenuItemChecked( IDM_BASIC_START ) )
					{	
						spInvertMenuItemCheck( IDM_BASIC_PRX );
											
						spTestItemActiveSycnMenuCheck( IDM_BASIC_PRX );
					}	
...
static BOOL spIsAnyBasicItemChecked()
{
	...
	if( spIsMenuItemChecked( IDM_BASIC_PRX ) )
		bRet = TRUE;
///	else	
...
static BOOL spCheckBasicMenu()
{
	...
	if( spIsMenuItemChecked( IDM_BASIC_START ) )
	{
		EnableMenuItem( hMenuBar, IDM_BASIC_PRX, MF_BYCOMMAND|MF_GRAYED );
...
///		EnableMenuItem( hMenuBar, IDM_BASIC_ONOFF, MF_BYCOMMAND|MF_GRAYED );		
	...
	{
		EnableMenuItem( hMenuBar, IDM_BASIC_PRX, MF_BYCOMMAND|MF_ENABLED );
...
static void SetTestSettingDefault()
{
	...
	{	
		...
		pMyBasicTest->DeActiveTestItem( IDM_BASIC_PRX );
...
static void SetTestSettingStress()
{
	...
	{	
		...
		pMyBasicTest->ActiveTestItem( IDM_BASIC_PRX );
