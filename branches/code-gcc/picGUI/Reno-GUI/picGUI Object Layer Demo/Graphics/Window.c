...
/*********************************************************************
* Function: WndSetText(WINDOW *pW, char *pText)
*
* Overview: sets text
*
********************************************************************/
void WndSetText(WINDOW *pW, char *pText)
{
	pW->pText = pText;
	pW->textHeight = GetTextHeight(pW->pGolScheme->pFont);
}
...
if(GetState(pW,WND_DRAW_CLIENT)){
            ...
            case WND_TITLE_BAR_DRAW:
                ...
                Bar(pW->left+GOL_EMBOSS_SIZE, pW->top+GOL_EMBOSS_SIZE,
                    pW->right-GOL_EMBOSS_SIZE, pW->top+GOL_EMBOSS_SIZE+WND_TITLE_HEIGHT);
