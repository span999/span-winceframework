	...
	while (1) {
		...
		{	///it suppose to be time out.. 
			...
			if(1)	///for NMEA test 
			{
				...
				char buf1[] = "$GPGGA,180946,3926.0581,N,11946.0002,W,2,10,1.1,1378.4,M,-22.1,M,,*4C\0";
				char buf2[] = "$GPGSA,A,3,02,04,05,07,09,17,24,26,28,29,,,2.1,1.1,1.8*30\0";
				char buf3[] = "$GPRMC,180948,A,3926.0582,N,11946.0003,W,0.0,153.8,070106,15.2,E,D*36\0";
				char buf4[] = "$GPGGA,180948,3926.0583,N,11946.0004,W,2,10,1.1,1378.4,M,-22.1,M,,*44\0";
				char buf5[] = "$GPGSA,A,3,02,04,05,07,09,17,24,26,28,29,,,2.1,1.1,1.8*30\0";
				char buf6[] = "$GPRMC,180950,A,3926.0584,N,11946.0005,W,0.0,153.8,070106,15.2,E,D*3F\0";
				char buf7[] = "$GPGGA,180950,3926.0585,N,11946.0006,W,2,10,1.1,1378.3,M,-22.1,M,,*4A\0";
				char buf8[] = "$GPGSA,A,3,02,04,05,07,09,17,24,26,28,29,,,2.1,1.1,1.8*30\0";
				char buf9[] = "$GPRMC,180952,A,3926.0586,N,11946.0007,W,0.0,153.8,070106,15.2,E,D*3D\0";
