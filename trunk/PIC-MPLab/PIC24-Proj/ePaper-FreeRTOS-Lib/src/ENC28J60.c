 ...
 * Darren Wenn			1/07/09 Modified for RTOS compliance
 *								Init of the SPI has been removed since
 *								it is performed in mainDemo.c
********************************************************************/
#define __ENC28J60_C
...
// semaphore controlling access to the SPI channel
...
void MACInit(void)
{
 ...
 // the SPI has already been configured in mainDemo.c
// so this configuration has been removed, the SPI channel
// will be run at 8Mhz (on PIC24F) and 10MHz (on PIC32)
// this is not ideal as the ENC could run at 20MHz however we
// are limited by the EEPROM speed.
